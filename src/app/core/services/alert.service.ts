...
export class AlertService {
  ...
  updateAlertStatus(alertCode: string, status: AlertStatus, reason: string): Observable<ApiResponse<any>> {
    return this.http.patch<ApiResponse<any>>(`${this.baseUrl}/${alertCode}/status`, { status, reason });
  }
}
